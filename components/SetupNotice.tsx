  ...
  return (
    <div className="card p-6">
      ...
      <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
        ...
        저장소의 <code className="rounded-md bg-white/50 px-1.5 py-0.5 dark:bg-white/10">README.md</code>{" "}
        에 적어두었어요.
      </p>
      ...
      <ol className="mt-4 space-y-2 text-sm text-slate-600 dark:text-slate-300">
        ...
        <li>
          ...
          <code className="rounded-md bg-white/50 px-1.5 py-0.5 dark:bg-white/10">
            supabase/schema.sql
          </code>{" "}
          내용을 붙여넣고 실행합니다.
        </li>
        <li>
          ...
          <code className="rounded-md bg-white/50 px-1.5 py-0.5 dark:bg-white/10">.env.local</code> 에
          아래 값을 채웁니다.
        </li>
      </ol>

      <pre className="mt-4 overflow-x-auto rounded-2xl bg-slate-900/85 p-4 text-xs text-slate-100">
